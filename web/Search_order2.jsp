<%-- 
    Document   : Search_order2
    Created on : Mar 1, 2024, 9:18:16 AM
    Author     : 91880
--%>
    ...
    <body>
       ...
       <section class="sub-header">
            ...
            <%
                       ...
                       if(date1!=null && date1!="" && pay!=null && pay!="")
                        {
                           if(pay.equals("CashOnDelivery"))
                            {
                              String str="select  * from receipt_cod where  pay_method='"+pay+"' and order_date='"+orderdate+"'";
            ...
            <%  }}
                        ...
                        {
                            String str="select  * from cust_receipt where  pay_method='"+pay+"' and order_date='"+orderdate+"'";
                            ResultSet rs=st.executeQuery(str);
                            while(rs.next())
                            {   
                                billid=rs.getInt(1); 
